...
#include "../ShaderTypes/Shader.h"		//Students make this file...
#include "../../NCLGLMesh/Mesh.h"		//And this one...
//#include "Model.h"
...
public:
	...
	void	DrawDebugSphere(const Model* sphere);
